                    ...
                    <div className="lg:w-1/2 md:w-2/3 mx-auto">
                        <form>
                            <div className="flex flex-wrap -m-2">
                                ...
                                <div className="p-2 w-full">
                                    <button className="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" type='submit' onClick={handleSubmit}>{!loader ? "Upload" : "Uploading..."}</button>
                                </div>
                            </div>
                        </form>
                    </div>
