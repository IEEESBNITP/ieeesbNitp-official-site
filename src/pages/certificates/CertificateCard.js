    ...
    return (
        <>
            <div className="flex flex-col items-center justify-center w-full max-w-sm mx-auto">
                <div className="w-full h-64 bg-gray-300 bg-center bg-cover rounded-lg shadow-md" style={{"backgroundImage": `url(${data.imgPath})`}}></div>
                ...
                <div className="w-56 -mt-10 overflow-hidden bg-white rounded-lg shadow-lg md:w-64 dark:bg-gray-800">
                    ...
                    <span class="font-bold text-gray-800 dark:text-gray-200">{data.date?data.date:null}</span>
